;(function () {
	...
	function FastClick(layer, options) {
		...
		// check support for {passive: true}
		var passiveSupport = (function checkPassiveListener() {
		...
		var passiveListenr = passiveSupport ? {passive:false} : false;
		...
		layer.addEventListener('touchstart', this.onTouchStart, passiveListenr);
		layer.addEventListener('touchmove', this.onTouchMove, passiveListenr);
		layer.addEventListener('touchend', this.onTouchEnd, passiveListenr);
		layer.addEventListener('touchcancel', this.onTouchCancel, passiveListenr);
	...
	*/
	...
	FastClick.prototype.destroy = function() {
		...
		layer.removeEventListener('touchstart', this.onTouchStart, passiveListenr);
		layer.removeEventListener('touchmove', this.onTouchMove, passiveListenr);
		layer.removeEventListener('touchend', this.onTouchEnd, passiveListenr);
		layer.removeEventListener('touchcancel', this.onTouchCancel, passiveListenr);
	};
